"""LicenseGate — feature entitlement checker for Brandguard.
...
Usage:
    ...
    # Decorator
    @license_gate.require_feature("std.brandguard.enterprise")
...
_FEATURE_TIER_MAP = {
    # Pro (Tier 2)
    "std.brandguard.advanced": ("Brandguard Advanced Validation", "Pro"),
    # Enterprise (Tier 1)
    "std.brandguard.enterprise": ("Brandguard Enterprise Reports", "Enterprise"),
}
